  ...
  data: {
    ...
    */
    ...
    polyline: [{
      ...
      {
        longitude: 121.00401885014045,
        latitude: 31.04970574942166
      },

      {
        longitude: 121.00393389419943,
        latitude: 31.050482762410283
      },
      ...
      {
        longitude: 121.00106438958186,
        latitude: 31.05929991636221
      },

      {
        longitude: 121.00100641167559,
        latitude: 31.059689922420866
      },
      ...
      {
        longitude: 120.9992400670124,
        latitude: 31.05363882527896
      },
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            if(recordName=='补给站:食安站'){
                var iconPath = "../../../imag/supplypoint1.png";
            } else if (recordName == '补给站:档案站'){
                var  iconPath = "../../../imag/supplypoint2.png";
            } else if (recordName == '补给站:政法站'){
            ...
            var marker = {
              ...
              height: 30,
              iconPath: iconPath,
              label: { content: record.name, color: "#009900"}
            }
            markers.push(marker);
          }
          var start = {
